...
abstract public class OnionProxyContext {
    ...
    protected final static String GEO_IP_NAME = "tor_files/tor_data/geoip.txt";
    protected final static String GEO_IPV_6_NAME = "tor_files/tor_data/geoip6.txt";
    protected final static String TORRC_NAME = "tor_files/tor_data/torrc.txt";
    ...
    public void installFiles() throws IOException, InterruptedException {
        ...
        //System.out.println(getClass().getResourceAsStream("../"+GEO_IP_NAME));
        //  InputStream is = getClass().getResourceAsStream(GEO_IP_NAME);
        FileUtilities.cleanInstallOneFile(getClass().getResourceAsStream("../"+GEO_IP_NAME), geoIpFile);
        FileUtilities.cleanInstallOneFile(getClass().getResourceAsStream("../"+GEO_IPV_6_NAME), geoIpv6File);
        FileUtilities.cleanInstallOneFile(getClass().getResourceAsStream("../"+TORRC_NAME), torrcFile);
        ...
        switch (OsData.getOsType()) {
            ...
            case MAC:
                FileUtilities.extractContentFromZip(getWorkingDirectory(),
                        getClass().getResourceAsStream("../tor_files/tor_essentials/tor.zip"));
                break;
            default:
