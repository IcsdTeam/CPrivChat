...
import tor_network.tor_controller.NetLayerStatus;
import tor_network.tor_controller.ServiceDescriptor;
import tor_network.freehaven.tor.control.ConfigEntry;
import tor_network.freehaven.tor.control.TorControlConnection;
...
public abstract class OnionProxyManager {
    ...
    public synchronized ServiceDescriptor createHiddenService(int port, NetLayerStatus listener) {
